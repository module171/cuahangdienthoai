...
object Server {
    ...
    var connectdb = "http://192.168.1.14:81/API/connectdb.php"
    var registeruser = "http://192.168.1.14:81/API/registeruser.php"
    var login = "http://192.168.1.14:81/API/login.php"
    var addproduct = "http://192.168.1.14:81/API/addproduct.php"
    var addloaisp = "http://192.168.1.14:81/API/addloaisp.php"
    var addHD = "http://192.168.1.14:81/API/addhoadon.php"
    var getAllProduct = "http://192.168.1.14:81/API/getspall.php"
    var getproductbyid = "http://192.168.1.14:81/API/getproductbyid.php"
    var searchproductbyname = "http://192.168.1.14:81/API/searchsp.php"
    var getuserbyemail = "http://192.168.1.14:81/API/getuserbyemail.php"
    var getalluser = "http://192.168.1.14:81/API/getuserall.php"
    var getallloai = "http://192.168.1.14:81/API/getloaiall.php"
    var updateItemInCart = "http://192.168.1.14:81/API/updateItemInCart.php"
    var getproductcart = "http://192.168.1.14:81/API/getcart.php"
    var getUserByEmail = "http://192.168.1.14:81/API/getuserbyemail.php"
    var getidorder = "http://192.168.1.14:81/API/getIdOrder.php"
    var insertItemToCart = "http://192.168.1.14:81/API/insertItemToCart.php"
    var deletedItemInCart = "http://192.168.1.14:81/API/deletedItemInCart.php"
    var updateinfo = "http://192.168.1.14:81/API/updateinfo.php"
    var insertdathang = "http://192.168.1.14:81/API/insertdathang.php"
    var updateorder = "http://192.168.1.14:81/API/updateorder.php"
    var insert = "http://192.168.1.14:81/API/insert.php"
}