...
class LoaiAdapter(var context: Context, var arrayloaisp: ArrayList<LoaiSanPham>) : BaseAdapter() {
    override fun getCount(): Int {
        return arrayloaisp.size
    }

    override fun getItem(i: Int): Any {
        return arrayloaisp[i]
    }
    ...
    override fun getView(i: Int, view: View, viewGroup: ViewGroup): View {
        ...
        val loaisp = getItem(i) as LoaiSanPham
        viewHolder!!.tenloai!!.text = loaisp.nametype + ""
        return view
    }
}