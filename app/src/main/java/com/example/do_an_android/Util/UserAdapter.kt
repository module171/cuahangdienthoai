...
class UserAdapter(var context: Context, var arrayusers: ArrayList<User>) : BaseAdapter() {
    ...
    override fun getView(i: Int, view: View, viewGroup: ViewGroup): View {
        ...
        val us = getItem(i) as User
        viewHolder!!.ten!!.text = us.nameuser + ""
        viewHolder.email!!.text = us.email + ""
        viewHolder.sdt!!.text = us.phone
        return view
    }
}