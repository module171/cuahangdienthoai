...
class Admin : AppCompatActivity() {
    var txtdssp: TextView? = null
    var txtdsloai: TextView? = null
    var txtdsuser: TextView? = null
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_admin)
        AnhXa()
        txtdsuser!!.isClickable = false
        txtdsuser!!.visibility = View.INVISIBLE
        txtdssp!!.setOnClickListener {
            finish()
            val intent = Intent(applicationContext, DanhSachSP_Admin::class.java)
            startActivity(intent)
        }
        txtdsuser!!.setOnClickListener {
            finish()
            val intent = Intent(applicationContext, DanhSachUser_Admin::class.java)
            startActivity(intent)
        }
        txtdsloai!!.setOnClickListener {
            finish()
            val intent = Intent(applicationContext, DanhSachLoaiSP_Admin::class.java)
            startActivity(intent)
        }
    }
    ...
    override fun onBackPressed() {
        finish()
        startActivity(Intent(applicationContext, ThongTinCaNhan::class.java))
    }
}